...
function expandConfig() {
  ...
  if (cfg.sparePiecesTop !== true) {
    cfg.sparePiecesTop = false;
  }
  if (cfg.sparePiecesBottom !== true) {
    cfg.sparePiecesBottom = false;
  }

  // draggable must be true if sparePieces is enabled
  if (cfg.sparePieces === true || cfg.sparePiecesTop === true || cfg.sparePiecesBottom === true ) {
    cfg.draggable = true;
  }
  ...
  if (cfg.hasOwnProperty('pieceTheme') !== true ||
    ...
    cfg.pieceTheme = (cfg.assetHost||'') + '/img/chesspieces/wikipedia/{piece}.png';
  }
...
function buildBoardContainer() {
  ...
  if (cfg.sparePieces === true || cfg.sparePiecesTop === true) {
  ...
  if (cfg.sparePieces === true || cfg.sparePiecesBottom === true ) {
    html += '<div class="' + CSS.sparePieces + ' ' +
...
function doAnimations(a, oldPos, newPos) {
  ...
  for (var i = 0; i < a.length; i++) {
    ...
    if (a[i].type === 'add' && cfg.sparePieces !== true && cfg.sparePiecesTop !== true && cfg.sparePiecesBottom !== true) {
...
function drawBoard() {
  ...
  } else if(cfg.sparePiecesTop === true) {
    if (CURRENT_ORIENTATION === 'white') {
      sparePiecesTopEl.html(buildSparePieces('black'));
    }
    else {
  ...
  } else if(cfg.sparePiecesBottom === true) {
    if (CURRENT_ORIENTATION === 'white') {
      sparePiecesBottomEl.html(buildSparePieces('white'));
    }
    else {
...
widget.trash = function() {
  ...
  for (var i = 0; i < arguments.length; i++) {
    ...
    // skip invalid arguments
    if (validSquare(arguments[i]) !== true) {
      error(2826, 'Invalid move passed to the move method.', arguments[i]);
      continue;
    }

	DRAGGED_PIECE_SOURCE = arguments[i];
	trashDraggedPiece();
	DRAGGED_PIECE_SOURCE = null;
  }
...
function mousedownSparePiece(e) {
  ...
  if (cfg.sparePieces !== true && cfg.sparePiecesTop !== true && cfg.sparePiecesBottom !== true) return;
