...
var reset = Spieler.reset = function(username,callback){
...
var result = Spieler.result = function(rated,whiteusername,blackusername,whiteresult,blackresult,nosave){
	...
	find(whiteusername,function(white){
		find(blackusername,function(black){
			...
			if(!nosave) white.save();
			if(!nosave) black.save();
