...
var add = Spiel.add = function(gameid,variant,color,player,callback) {
	var game = spiels[gameid] = new kriegspiel(gameid,variant,color,player);
	callback(game);
}
...
// --------------------------------------------------------------
// Constructor:
var kriegspiel = function(gameid,type,color,player) {
	this.gameid = gameid;	
